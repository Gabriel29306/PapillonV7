...
const ModalContent: React.FC<ModalContentProps> = ({ navigation, refresh, endRefresh }) => {
  ...
  const [elements, setElements] = useState<
    {
      id: string,
      component: React.FC<{onImportance: (input: number) => void}>
                | React.FC<{onImportance: (input: number) => void, navigation: NativeStackNavigationProp<RouteParameters, "HomeScreen" | "Homeworks", undefined>}>,
